...
fxdev = device_get_binding("MMA8653FC");
	...
	// k_sem_take(&fx8700_sem, K_FOREVER);
	k_sem_take(&fx8700_sem, K_NO_WAIT);
...
void fxos_init()
{
	...
	// fxdev = device_get_binding(DT_NXP_FXOS8700_0_LABEL);
	// fxdev = device_get_binding(DT_INST_0_NXP_FXOS8700_LABEL);	
