...
/* to hold sensor set-up/configuration attributes */
	...
	struct bt_mesh_sensor_setting_attr sensor_attr_list[2];

	// struct bt_mesh_sensor_setting_attr *sensor_attr_list ; /* = malloc(sizeof(sensor_attr_list) *2); */
	// int sensor_attr_list_size = 1;
#else
