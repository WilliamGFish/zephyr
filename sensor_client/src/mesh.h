...
#define _COUNT_TIMER_DELAY 		K_MSEC(7)	/* pseudo random numebr */
#define _EXT_SENSOR_TIMER_DELAY K_SECONDS(60)
#else
#define _COUNT_TIMER_DELAY 		K_MSEC(3)	/* pseudo random numebr */
#define _EXT_SENSOR_TIMER_DELAY K_SECONDS(30)

#endif

/* Health Server Fault count Maximum size hisorical register */
#define CUR_FAULTS_MAX 3
